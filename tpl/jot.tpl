...
<div id="profile-jot-wrapper" >
	...
	<form id="profile-jot-form" action="{{$action}}" method="post" >
		...
		<textarea provide-data="markdown" rows="5" cols="64" class="profile-jot-text" id="profile-jot-text" name="body" >{{if $content}}{{$content}}{{else}}{{$share}}{{/if}}</textarea>
		</div>

<div id="profile-jot-submit-wrapper" class="jothidden">
	<input type="submit" id="profile-jot-submit" name="submit" value="{{$share}}" class="btn btn-primary" />
