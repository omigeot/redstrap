...
{{/if}}
	...
	<div class="control-group" id="control-group-email">
		...
		<div class="controls">
			<div id="register-email-feedback" class="register-feedback help-inline"></div>
		...
		<input type="password" maxlength="72" size="32" name="password" id="register-password" class="register-input" value="{{$pass1}}" />
                <div class="controls">
			<div id="register-password-feedback" class="register-feedback help-inline"></div>
			<div id="register-password-end"  class="register-field-end"></div>
		</div>
	</div>

        <div class="control-group" id="control-group-password2">
		...
		<input type="password" maxlength="72" size="32" name="password2" id="register-password2" class="register-input" value="{{$pass2}}" />
                <div class="controls">
			<div id="register-password2-feedback" class="register-feedback help-inline"></div>
			<div id="register-password2-end"  class="register-field-end"></div>
		</div>
	</div>

	{{if $enable_tos}}
        <label for="register-tos" id="label-register-tos" class="checkbox">
	...
	<input class="btn btn-primary" type="submit" name="submit" id="register-submit-button" value="{{$submit}}" />
