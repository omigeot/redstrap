	...
	<div class="wall-item-content-wrapper {{$item.indent}}{{$item.previewing}}" id="wall-item-content-wrapper-{{$item.id}}" >
		<div class="wall-item-info" id="wall-item-info-{{$item.id}}">
			<div class="wall-item-photo-wrapper" id="wall-item-photo-wrapper-{{$item.id}}" 
				...
				<div class="dropdown">
					<a class="dropdown-toggle wall-item-photo-menu-button" id="wall-item-photo-menu-button-{{$item.id}}" data-toggle="dropdown" rel="#content-user-menu" href="#"><span class="icon-chevron-down"></span></a>
					<ul id="content-user-menu" class="dropdown-menu" role="menu" aria-labelledby="dLabel">
